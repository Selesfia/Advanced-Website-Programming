...
R.list = function (posts) {
  ...
  for (let post of posts) {
    ...
    <li>
      <h2>${post.title}</h2>
      <p><a id="show${post.id}" href="#show/${post.id}">View Contact</a></p>
    </li>
    `)
  }
  let content = `
...
R.new = function () {
  ...
  <p>Add new contact</p>
  <form>
    <p><input id="title" type="text" placeholder="Title" name="Name"></p>
    <p><textarea id="body" placeholder="Contents" name="Phone number"></textarea></p>
